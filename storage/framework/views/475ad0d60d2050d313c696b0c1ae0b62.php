...
<head>
    ...
    <title><?php echo e($data['nama']); ?> - Cerita Farhan</title>
...
<body class="text-gray-900 p-6 md:p-12 overflow-x-hidden">
    ...
    <div class="max-w-4xl mx-auto">
        <a href="<?php echo e(url('/')); ?>" class="inline-block bg-white border-4 border-black font-bold py-2 px-6 mb-10 shadow-[4px_4px_0_0_rgba(0,0,0,1)] transition-all active:translate-y-1 active:translate-x-1 active:shadow-none hover:bg-[#FFE156]">
            <- Balik ke Menu
        </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div class="h-64 bg-gray-200 border-4 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)] flex items-center justify-center overflow-hidden">
                <img src="<?php echo e(asset('images/' . $data['foto1'])); ?>" alt="Foto 1" class="object-contain w-full h-full">
            </div>
            <div class="h-64 bg-gray-200 border-4 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)] flex items-center justify-center overflow-hidden">
                <img src="<?php echo e(asset('images/' . $data['foto2'])); ?>" alt="Foto 2" class="object-contain w-full h-full">
            </div>
        </div>
    </div>

</body>
</html><?php /**PATH C:\Users\Nitro V 15\farhan-adventures\resources\views/detail.blade.php ENDPATH**/ ?>